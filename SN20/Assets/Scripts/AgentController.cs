...
public class AgentController : Agent
{
    ...
    public override void OnEpisodeBegin()
    {
        ...
        if (m_ResetParams.GetWithDefault("landing_speed", 5) != rc.landing_speed)
        {
            Debug.Log("NOUVELLE LECON, SUR LE landing_speed. ANCIENNE VALEUR:" + rc.landing_speed + ", NOUVELLE VALEUR:" + m_ResetParams.GetWithDefault("landing_speed", 5));
            rc.landing_speed = m_ResetParams.GetWithDefault("landing_speed", 5);
        }
        */

        if (m_ResetParams.GetWithDefault("init_height", 50) != rc.height)
        {
            Debug.Log("NOUVELLE LECON, SUR LA init_height. ANCIENNE VALEUR:" + rc.height + ", NOUVELLE VALEUR:" + m_ResetParams.GetWithDefault("init_height", 50));
            rc.height = m_ResetParams.GetWithDefault("init_height", 50);
        }

        if (m_ResetParams.GetWithDefault("init_angle_roll", 0) != rc.init_angle_roll)
        {
            Debug.Log("NOUVELLE LECON, SUR LA init_angle_roll. ANCIENNE VALEUR:" + rc.init_angle_roll + ", NOUVELLE VALEUR:" + m_ResetParams.GetWithDefault("init_angle_roll", 0));
        ...
        {
            Debug.Log("NOUVELLE LECON, SUR LA init_angle_pitch. ANCIENNE VALEUR:" + rc.init_angle_pitch + ", NOUVELLE VALEUR:" + m_ResetParams.GetWithDefault("init_angle_pitch", 0));
        ...
        {
            Debug.Log("NOUVELLE LECON, SUR LA init_xoffset. ANCIENNE VALEUR:" + rc.init_xoffset + ", NOUVELLE VALEUR:" + m_ResetParams.GetWithDefault("init_xoffset", 4));
        ...
        {
            Debug.Log("NOUVELLE LECON, SUR LA init_zoffset. ANCIENNE VALEUR:" + rc.init_zoffset + ", NOUVELLE VALEUR:" + m_ResetParams.GetWithDefault("init_zoffset", 4));
            rc.init_zoffset = m_ResetParams.GetWithDefault("init_zoffset", 4);
        }

        if (m_ResetParams.GetWithDefault("init_zspeed", 0) != rc.init_zspeed)
        {
            Debug.Log("NOUVELLE LECON, SUR LA init_zspeed. ANCIENNE VALEUR:" + rc.init_zspeed + ", NOUVELLE VALEUR:" + m_ResetParams.GetWithDefault("init_zspeed", 0));
            rc.init_zspeed = m_ResetParams.GetWithDefault("init_zspeed", 0);
        }

        if (m_ResetParams.GetWithDefault("angle_tvc", 5) != rc.angle_tvc)
        {
            Debug.Log("NOUVELLE LECON, SUR LA angle_tvc. ANCIENNE VALEUR:" + rc.angle_tvc + ", NOUVELLE VALEUR:" + m_ResetParams.GetWithDefault("angle_tvc", 5));
            rc.angle_tvc = m_ResetParams.GetWithDefault("angle_tvc", 5);
        }

        if (m_ResetParams.GetWithDefault("thrust_engine", 4000) != rc.thrust_engine)
        {
            Debug.Log("NOUVELLE LECON, SUR LA thrust_engine. ANCIENNE VALEUR:" + rc.thrust_engine + ", NOUVELLE VALEUR:" + m_ResetParams.GetWithDefault("thrust_engine", 4000));
        ...
        {
            Debug.Log("NOUVELLE LECON, SUR LA thrust_rcs. ANCIENNE VALEUR:" + rc.thrust_rcs + ", NOUVELLE VALEUR:" + m_ResetParams.GetWithDefault("thrust_rcs", 2.5f));
        ...
        {
            Debug.Log("NOUVELLE LECON, SUR LA collision_speed. ANCIENNE VALEUR:" + rc.collision_speed + ", NOUVELLE VALEUR:" + m_ResetParams.GetWithDefault("collision_speed", 5));
